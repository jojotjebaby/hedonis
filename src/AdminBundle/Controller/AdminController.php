...
class AdminController extends Controller
{
    ...
    /**
     * @Route("/subscribers", name="admin_subscribers")
     */
    ...
    /**
     * @Route("/articles/mod/{id}", name="admin_articles_mod")
     */
    ...
    /**
     * @Route("/articles/del/{id}", name="admin_articles_del")
     */
    ...
    /**
     * @Route("/sales/add", name="admin_sales_add")
     */
    ...
    /**
     * @Route("/sales/mod/{id}", name="admin_sales_mod")
     */
    ...
    /**
     * @Route("/sales/del/{id}", name="admin_sales_del")
     */
